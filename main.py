...
def process_twitter():
    try:
        ...
        user_details_url = f'https://api.twitter.com/1.1/users/show.json?user_id={user_id}'
        ...
        user_details = requests.request('GET', user_details_url, headers={
...
def invoke_twitter_api():
    try:
        ...
        hmac_signature = create_twitter_signature('POST', 'https://api.twitter.com/oauth/request_token', parameters=oauth_headers, consumer_secret=consumer_secret)
