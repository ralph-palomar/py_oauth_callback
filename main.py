...
def generate_twitter_auth_header():
    try:
        ...
        # log_payload("SIGNING KEY", signing_key)
        hmac_signature = base64.b64encode(hmac.new(bytes(signing_key, 'utf-8'), bytes(output_string, 'utf-8'), sha1).hexdigest()).decode()
        ...
        log_payload("FINAL_OUTPUT", output)
